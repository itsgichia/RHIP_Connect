            ...
            <div className="divide-y divide-gray-50 max-h-[520px] overflow-y-auto">
              {threads.map((t) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    {t.last_message_at && (
                      <RelativeTime
                        value={t.last_message_at}
                        className="text-[10px] text-rhip-muted"
                      />
                    )}
                  </div>
                </button>
              ...
              {threads.length === 0 && (
                <p className="p-6 text-sm text-rhip-muted text-center">
                  No conversations yet. Start one from the Expertise Directory or a challenge match.
                </p>
              )}
            </div>
          )}
        ...
        <div className="lg:col-span-2 bg-white rounded-2xl shadow-sm p-6">
          {threadId ? (
            ...
            <div className="flex items-center justify-center h-full min-h-[480px] text-rhip-muted">
              Select a conversation, or contact someone from the Expertise Directory
            </div>
          )}
        </div>
      </div>
